...
* Problem 3
 ...
 operations over machine learning tasks. As a consequence, it will be more
 power efficient and performant than CPU. Good at multiply-accumulate
 calculation Paralized computation Computation logic is very simple? Good for
 massive multi-media data Focus on low precission operations
